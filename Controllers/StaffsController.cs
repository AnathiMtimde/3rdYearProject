...
namespace DGSappSem2.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public async System.Threading.Tasks.Task<ActionResult> Create([Bind(Include = "StaffId,Name,Surname,Gender,DateOfBirth,Email,PhoneNo,Grade,Subject,Address,Position")] Staff staff)
        {
