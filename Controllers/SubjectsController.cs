...
namespace DGSappSem2.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public JsonResult getSubjects(int termId,int classRoomId)
        {
            var rl = new ReportLogic();
            return new JsonResult { Data =rl.GetGraphicalReports(classRoomId, termId) , JsonRequestBehavior = JsonRequestBehavior.AllowGet };
        }
        ...
        public ActionResult SubjectReport(int termId, int classRoomId)
        {
            return View(new{termId, classRoomId});
        }
        ...
        public ActionResult Create([Bind(Include = "SubjectID,SubjectName,RequiredPercentage,ClassRoomID")] Subject subject, HttpPostedFileBase Upload)
        {
